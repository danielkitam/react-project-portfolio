...
const Contact = () => {
  return (
    ...
    to-gray-800 p-4 text-white'>
        <div name='contact' className='flex flex-col p-4 justify-center max-w-screen-lg
             mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl font0bold inline border-b-4
                 border-gray-500'>
                    Contact
                </p>
            ...
            <div className='flex justify-center items-center'>
                <form 
                  action='https://getform.io/f/4ef51cbb-6828-4ffb-a1ea-866b1f364d3f' 
                  method='POST'
